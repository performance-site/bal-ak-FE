  ...
  http.get('**/performances/:performanceId', () => {
    return HttpResponse.json({
      ...
      data: {
        ...
        dateTime: '2025.12.05.',
        venue: '플랙스라운지 1호점',
        preSaleFormUrl: 'https://github.com/orgs/performance-site/repositories',
    ...
    return HttpResponse.json({
      ...
      data: {
        track: {
          ...
          albumImgUrl:
            'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRkRawnuIyosVD5ha8yrgaicbDvLhbHDs5J1g&s',
        },
        team: [
          {
            session: 'VOCAL',
